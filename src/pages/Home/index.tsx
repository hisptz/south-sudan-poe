...
const Home = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <p style={{textAlign: "justify"}}>We are glad that you have chosen to travel to South Sudan. For your safety
                and the well-being of those around you, please be informed <br/>
                that it is mandatory to complete the Public Health Surveillance Form online within 24 hours before
                arrival. You can start by searching <br/>
