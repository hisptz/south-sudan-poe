...
export default function NoResults() {
    ...
    return (
        <div style={{
            ...
            <p>{i18n.t("Sorry, we couldn't find any bookings for your passport number", {
                context: "The passport is shown next to these words in bold"
            })} <b>{currentSearchedPassportNumber}</b>.</p>
            <Button
                onClick={() => navigate('/registration', {state: {passportId: currentSearchedPassportNumber}})}>{
